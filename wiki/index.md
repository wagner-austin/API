...
**Known coverage shape, stated so nobody mistakes silence for absence:** 22 of these pages are ClearGBM. The services, clients and infrastructure hubs are thin relative to what the monorepo holds — 13 services and 4 clients against 2 service pages and 0 client pages. Client depth is deliberate (three clients keep their own full wikis); service and infrastructure depth is a real gap.
...
[Infrastructure](hubs/infrastructure.md) -- docker-compose, Traefik, Redis/RQ, PostgreSQL, monorepo build + test + lint conventions, run-comparability env (2 pages)
