...
class _CudaModuleProtocol(Protocol):
...
class _TorchModuleProtocol(Protocol):
    ...
    def from_numpy(self, ndarray: NDArray[np.float64]) -> TensorProtocol: ...
    ...
    @property
    def float32(self) -> DTypeProtocol: ...
    @property
    def float16(self) -> DTypeProtocol: ...
    @property
    def bfloat16(self) -> DTypeProtocol: ...
    @property
    def long(self) -> DTypeProtocol: ...
    @property
    def int64(self) -> DTypeProtocol: ...
...
class TensorProtocol(Protocol):
    ...
    def argmax(self, dim: int | None = None) -> TensorProtocol: ...
    def requires_grad_(self, requires_grad: bool = True) -> TensorProtocol: ...
    def select(self, dim: int, index: int) -> TensorProtocol: ...
    def sum(self) -> TensorProtocol: ...
