"""MLP classifier backend: persistence, inference, gradients."""
...
def test_mlp_model_factory_protocol_exported() -> None:
    ...
    from covenant_nn.backends.mlp.model import MLPFactory, __all__
...
def test_mlp_backend_capabilities_returns_dict() -> None:
    """MLPBackend.capabilities returns MLP_CAPABILITIES."""
    from covenant_nn.backends.mlp.backend import MLP_CAPABILITIES
...
def test_mlp_compute_gradients_returns_correct_shape() -> None:
    ...
    from covenant_nn.backends.mlp.backend import _MLPPrepared
    from covenant_nn.backends.mlp.backend_training import _build_model
