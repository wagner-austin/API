"""Production hook impls: files, console, tokens, HTTP."""
...
class TestProdHttpHooks:
    def test_http_get_makes_request_with_headers(self) -> None:
        ...
        from platform_calendar._prod_hooks import _prod_http_get
    ...
    def test_http_post_makes_request(self) -> None:
        ...
        from platform_calendar._prod_hooks import _prod_http_post
...
class TestProdOpenBrowser:
    def test_calls_opener_with_url(self) -> None:
        ...
        from platform_calendar._prod_hooks import _prod_open_browser
...
class TestProdConsoleInput:
    def test_returns_input_from_func(self) -> None:
        ...
        from platform_calendar._prod_hooks import _prod_console_input
