...
class TestProdCliGetEnv:
    ...
    def test_loads_env_file_when_exists(self, tmp_path: Path) -> None:
        ...
        # Reset state
        testing._cli_env_loaded = False
        testing._cli_env_cache = {}

        # Temporarily change the module directory
        original_file = testing.__file__
        testing.__file__ = str(tmp_path / "platform_calendar" / "testing.py")
        ...
        testing.__file__ = original_file
        testing._cli_env_loaded = original_env_loaded
        testing._cli_env_cache = original_env_cache
...
class TestProdCliSetEnv:
    def test_sets_value_in_cache(self) -> None:
        ...
        # Verify it was set
        assert testing._cli_env_cache.get("TEST_SET_KEY") == "test_set_value"

        # Clean up
        testing._cli_env_cache = original_cache
