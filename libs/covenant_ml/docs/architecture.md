...
class ExplainerRegistry:
    def get(self, name: ExplainerName) -> ExplainerAdapter: ...
    def list_explainers(self) -> tuple[ExplainerName, ...]: ...
    def list_compatible_explainers(self, backend: BackendName) -> tuple[ExplainerName, ...]: ...
    def is_compatible(self, explainer: ExplainerName, backend: BackendName) -> bool: ...
```
