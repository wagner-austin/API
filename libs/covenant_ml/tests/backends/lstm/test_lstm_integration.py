"""LSTM backend integration tests with actual PyTorch training.
...
def test_lstm_wrapper_load_state_dict_with_extra_key() -> None:
    ...
    """
    from covenant_ml.backends.lstm.backend import _build_model
...
def test_lstm_compute_gradients_returns_correct_shape() -> None:
    ...
    from covenant_ml.backends.lstm.backend import _build_model, _LSTMPrepared
