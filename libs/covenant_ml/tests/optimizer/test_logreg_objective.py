"""Tests for Logistic Regression objective function.

Uses real sklearn LogisticRegression for integration testing. No mocks.
"""
...
def _make_default_int_params() -> SampledIntParams:
    ...
    Returns:
        SampledIntParams with typical LogReg values.
    """
    return SampledIntParams(max_iter=300)
...
def _make_default_float_params() -> SampledFloatParams:
    ...
    Returns:
        SampledFloatParams with typical LogReg values.
    """
    return SampledFloatParams(C=1.0, tol=1e-4)
...
def _make_default_string_params() -> SampledStringParams:
    ...
    Returns:
        SampledStringParams with typical LogReg values.
    """
    return SampledStringParams(penalty="l2", solver="saga")


# =============================================================================
# Tests: LogRegObjective Initialization
# =============================================================================


class TestLogRegObjectiveInit:
    """Tests for LogRegObjective initialization."""
...
# =============================================================================
# Tests: LogRegObjective Call
# =============================================================================


class TestLogRegObjectiveCall:
    """Tests for LogRegObjective.__call__ method."""
    ...
    def test_with_l1_penalty(self) -> None:
        ...
        auc = objective(
            ...
            y_labels=y,
            feature_names=names,
            int_params=SampledIntParams(max_iter=500),
            float_params=SampledFloatParams(C=0.5, tol=1e-4),
            string_params=SampledStringParams(penalty="l1", solver="saga"),
            train_ratio=0.7,
            val_ratio=0.15,
            test_ratio=0.15,
            random_state=42,
    ...
    def test_with_different_c_values(self) -> None:
        ...
        auc_low_c = objective(
            ...
            feature_names=names,
            int_params=_make_default_int_params(),
            float_params=SampledFloatParams(C=0.001, tol=1e-4),
            string_params=_make_default_string_params(),
            train_ratio=0.7,
            val_ratio=0.15,
            test_ratio=0.15,
        ...
        auc_high_c = objective(
            x_features=x,
            y_labels=y,
            feature_names=names,
            int_params=_make_default_int_params(),
            float_params=SampledFloatParams(C=100.0, tol=1e-4),
            string_params=_make_default_string_params(),
            train_ratio=0.7,
            val_ratio=0.15,
            test_ratio=0.15,
        ...
        assert 0.0 <= auc_low_c <= 1.0
        assert 0.0 <= auc_high_c <= 1.0
...
class TestCreateLogRegObjective:
    """Tests for create_logreg_objective factory function."""
...
class TestNFeaturesProperty:
    """Tests for LogRegObjective.n_features property."""
