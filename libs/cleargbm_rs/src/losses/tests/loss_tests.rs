...
fn test_binary_log_loss_perfect_predictions() -> Result<(), ClearGbmError> {
    ...
    let loss = match binary_log_loss(&y_true, &y_pred, 1.0_f64) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
    assert!(
...
fn test_binary_log_loss_symmetric() -> Result<(), ClearGbmError> {
    ...
    let loss_pos = match binary_log_loss(&[1_u8], &[0.8_f64], 1.0_f64) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
    let loss_neg = match binary_log_loss(&[0_u8], &[0.2_f64], 1.0_f64) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
    assert!(
...
fn test_binary_log_loss_empty_input() -> Result<(), ClearGbmError> {
    let result = binary_log_loss(&[], &[], 1.0_f64);
    match result {
...
fn test_binary_log_loss_length_mismatch() -> Result<(), ClearGbmError> {
    let result = binary_log_loss(&[0_u8, 1_u8], &[0.5_f64], 1.0_f64);
    match result {
...
fn test_binary_log_loss_invalid_label() -> Result<(), ClearGbmError> {
    let result = binary_log_loss(&[0_u8, 2_u8], &[0.5_f64, 0.5_f64], 1.0_f64);
    match result {
...
fn test_binary_log_loss_weighted_exact_value() -> Result<(), ClearGbmError> {
    ...
    let result = match binary_log_loss(&y_true, &y_pred, 3.0_f64) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
...
fn test_binary_log_loss_weight_one_matches_unweighted_mean() -> Result<(), ClearGbmError> {
    ...
    let result = match binary_log_loss(&y_true, &y_pred, 1.0_f64) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
...
fn test_binary_log_loss_rejects_nonpositive_weight() -> Result<(), ClearGbmError> {
    let result = binary_log_loss(&[1_u8, 0_u8], &[0.5_f64, 0.5_f64], -1.0_f64);
    match result {
...
fn test_binary_log_loss_rejects_infinite_weight() -> Result<(), ClearGbmError> {
    let result = binary_log_loss(&[1_u8, 0_u8], &[0.5_f64, 0.5_f64], f64::INFINITY);
    match result {
