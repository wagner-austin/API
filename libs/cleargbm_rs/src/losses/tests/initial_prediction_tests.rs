...
fn test_initial_prediction_balanced() -> Result<(), ClearGbmError> {
    ...
    let result = match binary_log_loss_initial_prediction(&[0_u8, 1_u8], 1.0_f64, None) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
    assert!(
...
fn test_initial_prediction_balanced_larger() -> Result<(), ClearGbmError> {
    ...
    let result = match binary_log_loss_initial_prediction(&labels, 1.0_f64, None) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
    assert!(
...
fn test_initial_prediction_antisymmetric() -> Result<(), ClearGbmError> {
    ...
    let result_pos = match binary_log_loss_initial_prediction(&mostly_pos, 1.0_f64, None) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
    let result_neg = match binary_log_loss_initial_prediction(&mostly_neg, 1.0_f64, None) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
    assert!(
...
fn test_initial_prediction_empty() -> Result<(), ClearGbmError> {
    let result = binary_log_loss_initial_prediction(&[], 1.0_f64, None);
    match result {
...
fn test_initial_prediction_all_zeros() -> Result<(), ClearGbmError> {
    let result = binary_log_loss_initial_prediction(&[0_u8, 0_u8, 0_u8], 1.0_f64, None);
    match result {
...
fn test_initial_prediction_all_ones() -> Result<(), ClearGbmError> {
    let result = binary_log_loss_initial_prediction(&[1_u8, 1_u8, 1_u8], 1.0_f64, None);
    match result {
        Err(ClearGbmError::InvalidParameter { name, reason }) => {
            assert_eq!(name, "y_true");
...
fn test_initial_prediction_invalid_label() -> Result<(), ClearGbmError> {
    let result = binary_log_loss_initial_prediction(&[0_u8, 1_u8, 5_u8], 1.0_f64, None);
    match result {
...
fn test_initial_prediction_weighted_balances_imbalance() -> Result<(), ClearGbmError> {
    ...
    let result = match binary_log_loss_initial_prediction(&labels, 3.0_f64, None) {
        Ok(v) => v,
        Err(e) => return Err(e),
    };
...
fn test_initial_prediction_rejects_nonpositive_weight() -> Result<(), ClearGbmError> {
    let result = binary_log_loss_initial_prediction(&[0_u8, 1_u8], 0.0_f64, None);
    match result {
        Err(ClearGbmError::InvalidParameter { name, reason }) => {
...
fn test_initial_prediction_rejects_nan_weight() -> Result<(), ClearGbmError> {
    let result = binary_log_loss_initial_prediction(&[0_u8, 1_u8], f64::NAN, None);
    match result {
