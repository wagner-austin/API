"""Turning JSON text into values, and reporting the text that is not JSON.

Splitting this file: the narrowing helpers moved to test_json_narrowing.py
and the field readers to test_json_fields.py when the three roles together
