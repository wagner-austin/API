...
def test_tokenizer_enqueue_with_corpus_file_id(tmp_path: Path) -> None:
    """Test that corpus_file_id is passed through to the enqueued job payload."""
    # Set up fake queue to capture enqueued jobs
    ...
    # Verify the job was enqueued with the correct corpus_file_id
    ...
    assert payload["corpus_file_id"] == "deadbeef"
