...
class TestDomainRegistry:
    ...
    def test_register_and_get(self) -> None:
        ...
        registry = DomainRegistry()
        domain = make_fake_domain("weather")
    ...
    def test_register_and_list_names(self) -> None:
        ...
        registry = DomainRegistry()
        registry.register(make_fake_domain("weather"))
        registry.register(make_fake_domain("covenant"))
    ...
    def test_key_error_message_lists_available(self) -> None:
        ...
        registry = DomainRegistry()
        registry.register(make_fake_domain("alpha"))
        registry.register(make_fake_domain("beta"))
    ...
    def test_list_names_sorted(self) -> None:
        ...
        registry = DomainRegistry()
        registry.register(make_fake_domain("zulu"))
        registry.register(make_fake_domain("alpha"))
        registry.register(make_fake_domain("mike"))
    ...
    def test_register_multiple_domains(self) -> None:
        ...
        registry = DomainRegistry()
        registry.register(make_fake_domain("a"))
        registry.register(make_fake_domain("b"))
        registry.register(make_fake_domain("c"))
