"""RQ worker entry point for covenant-radar-api background jobs."""
...
def main(
    ...
    """Start the RQ worker for covenant-radar-api background jobs.
    ...
    setup_logging(
        level="INFO",
        format_mode="json",
        service_name="covenant-radar-worker",
        instance_id=None,
        extra_fields=None,
    )
