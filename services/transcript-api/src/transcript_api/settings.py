...
def build_config_from_env() -> Config:
    return Config(
        TRANSCRIPT_MAX_VIDEO_SECONDS=_parse_int("TRANSCRIPT_MAX_VIDEO_SECONDS", 3600),
        TRANSCRIPT_MAX_FILE_MB=_parse_int("TRANSCRIPT_MAX_FILE_MB", 100),
        TRANSCRIPT_ENABLE_CHUNKING=_parse_bool("TRANSCRIPT_ENABLE_CHUNKING", True),
