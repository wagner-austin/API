...
three sibling bridges. What is here is only what is true of THIS bridge.
...
BRIDGE_AGENT: Final = "bridge-lock-wake-0909"

#: The fixed name the bridge's session id is derived from. NEVER EDIT.
_SESSION_NAME: Final = "corvis:lock-wake:bridge"
