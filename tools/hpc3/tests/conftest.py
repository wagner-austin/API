...
DECLARED_LABEL = "fable-brain-audit-0903"


def _make_declared_label() -> Generator[str, None, None]:
    """Pin the environment's board label so the recorded submitter is assertable.

    Pins :data:`platform_core.config.config_test_hooks.get_env` rather than a
    ...
    yield DECLARED_LABEL
    config_test_hooks.get_env = previous
...
declared_label = pytest.fixture(_make_declared_label)
