...
def decode_ai_config(data: JSONObject) -> AIConfigDict:
    ...
    return AIConfigDict(
        ...
        map_intel_horizon_ms=require_int(data, "map_intel_horizon_ms"),
...
def encode_ai_state(state: AIStateDict) -> JSONObject:
    ...
    return {
        ...
        "resource_target_held_ticks": state["resource_target_held_ticks"],
        ...
        "scope_scout_looks": dict(state["scope_scout_looks"]),
...
def decode_ai_state(data: JSONObject) -> AIStateDict:
    ...
    return AIStateDict(
        ...
        resource_target_held_ticks=require_int(data, "resource_target_held_ticks"),
        ...
        scope_scout_looks=_require_str_int_mapping(data, "scope_scout_looks"),
