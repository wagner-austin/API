...
[Flag Triage 2026-09-02](../pages/flag-triage-20260902.md) -- the engagement break is unwinnable by arithmetic below lieutenant rank (4 hits/10s makes a healthy same-rank target permanently unkillable), and the mine pin re-mines a tile when targets alternate
