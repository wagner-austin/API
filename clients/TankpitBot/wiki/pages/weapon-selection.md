...
wall. you can use dual shots across water ofc."[^3]
...
- ``weapon = 0`` → free single, nothing debited → **miss**[^2]
...
on consumption; ``victim_id`` is kill-attribution metadata only.[^2]
