...
| 12 | Harvest frame-shift toward stock the hop lane teleports onto (2026-09-03 validation run, 20:03:50) | **open** — the frame shift buys nothing when the walk lane cannot serve the target post-shift; `block_harvest.py` should defer to the teleport lane in that shape |
