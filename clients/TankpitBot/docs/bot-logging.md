...
AI: COLLECT_FUEL score=900 target=(120,137) cmd=radar equip=dual,homing,radar reason=radar_for_fuel
...
This is why recent logs may show `radar_for_fuel` or `radar_for_equipment`
before acting on apparently visible containers. The planner is avoiding ghost
targets from sparse cache updates.
