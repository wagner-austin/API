...
This file is a human-maintained protocol reference.

The authoritative command IDs and wire builders live in:
...
byte 2: id (e.g. 112=MOVE, 106=PICKUP, 116=TELEPORT, 102=RADAR)
...
### Radar
```
Client: [SENT] CMD: ! type=2 id=102    # Radar command
