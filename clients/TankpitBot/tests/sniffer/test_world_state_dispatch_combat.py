...
class TestCombatHitTracking:
    ...
    def test_zero_weapon_byte_sets_our_shot_response(self) -> None:
        ...
        ws = WorldService()
        mark_combat_hit(ws, weapon_byte=0, victim_id=-1)
        assert peek_our_shot_response(ws) is True
    ...
    def test_dual_hit_decrements_dual_count(self) -> None:
        ...
        mark_combat_hit(ws, weapon_byte=1, victim_id=999)
        assert get_inventory_state(ws)["dual_shots"]["count"] == 6
        assert get_inventory_state(ws)["dual_shots"]["enabled"] is True
    ...
    def test_missile_hit_decrements_missile_count(self) -> None:
        ...
        mark_combat_hit(ws, weapon_byte=2, victim_id=999)
        assert get_inventory_state(ws)["missile_shots"]["count"] == 4
    ...
    def test_homing_hit_decrements_homing_count(self) -> None:
        ...
        mark_combat_hit(ws, weapon_byte=3, victim_id=999)
        assert get_inventory_state(ws)["homing_shots"]["count"] == 2
    ...
    def test_unknown_weapon_byte_decrements_nothing(self) -> None:
        ...
        mark_combat_hit(ws, weapon_byte=99, victim_id=999)
    ...
    def test_consecutive_hits_deplete_dual(self) -> None:
        ...
        mark_combat_hit(ws, weapon_byte=1, victim_id=999)
        assert get_inventory_state(ws)["dual_shots"]["count"] == 2
        mark_combat_hit(ws, weapon_byte=1, victim_id=999)
        assert get_inventory_state(ws)["dual_shots"]["count"] == 1
        mark_combat_hit(ws, weapon_byte=1, victim_id=999)
        assert get_inventory_state(ws)["dual_shots"]["count"] == 0
