"""Coverage for equipment_probe_attempt.py lines 366-376 and 381."""
...
# ---- Typed stubs matching exact Protocol signatures ----
...
# Fully typed fakes matching RunTrackedTeleportAttemptProtocol exactly
