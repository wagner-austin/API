"""Round-trip tests for the record- and scorecard-level issue-report codecs.

The whole-``IssueReportDict`` codec tests live in
``test_issue_report_codec.py`` (split 2026-08-20, at the file-size bar).
"""
