...
[^3]: `[observed]` — `C:\Users\Test\PROJECTS\upstream\mujoco_warp-repro\repro_hfield_drop.py RUN_TO_RUN 64 60`, the same script and arguments as [^1], after the fix: `final_z=0.099233 total_contacts=50 zero_contact_steps=35/60`, matching the default arm exactly.
