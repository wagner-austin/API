...
final class ThinkCountTransformer implements ClassFileTransformer {
    ...
    private final java.util.Map<String, java.util.LinkedHashMap<String, String>> scans =
            Targets.thinkScans();
    private final java.util.Map<String, java.util.LinkedHashMap<String, String>> values =
            Targets.thinkValues();
    private final java.util.Map<String, java.util.LinkedHashMap<String, String>> arg1s =
            Targets.thinkArg1s();
    ...
    public byte[] transform(
        ...
        java.util.LinkedHashMap<String, String> valueHooks = values.get(className);
        if (valueHooks == null) {
            valueHooks = new java.util.LinkedHashMap<String, String>();
        }
        java.util.LinkedHashMap<String, String> arg1Hooks = arg1s.get(className);
        if (arg1Hooks == null) {
