...
[The Very Hard Race: 96 Games, Where the 27 Losses Are Decided](../pages/very-hard-race.md) -- the certified 96-game corpus read with the enemy peak line: losses are the long games, decided at the mid-game fight by sample 2000, and every verb that converts an opener costs winners two to one
...
[The Build-Priority Head](../pages/impossible-build-priority-head.md) -- step three's option 2 made concrete: the budget-walk decision point, the 7,830-trace corpus, and the label problem the noise floor prices
[The Tactical Genome](../pages/impossible-tactical-genome.md) -- stage three re-founded as search after every label died: the reflex layer's constants become alleles, the proven population searcher provides the training, the floor prices the schedule
