...
| Hard (duel_lake, modern policy) | `evolve1-g4m2` | **48/48 won on the verdict panel** (hardnuke96, 2026-09-05); 71/72 across all of the day's fresh panels | The certification stalemate did not reproduce on current code (single-seed cross-version reads are noise, logged as such). Two knobs asked and refused at panel grade the same day: close 3 turned 3 wins into WIPES (the all-in releases a weak army from held positions), and nukes 1 -- a 12/12 screen sweep -- fell at verdict grade with the panel's only non-win, a stalemate the champion won. The day's one champion loss (1/72) is a navy grind: worn down over 7,380 samples by battleships and missile ships at rival worth 142,900 -- the rung's rare tail, unsized. |
