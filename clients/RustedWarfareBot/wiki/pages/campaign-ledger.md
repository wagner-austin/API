...
- The interception, on the same seeds (log 2026-09-14, [[very-hard-race]]): off reads 59 to the champion's 69 (15 gained, 25 lost), so the reserve turning on raiders is worth ten wins; bounded to three units reads 68 (11 gained, 12 lost), the largest flip count of any arm on the bar for a net of minus one. Motivated by the kill ledger's finding that the losses trade a fifth worse in the 1,000-1,500 window at every starting size of the rival's army; the interception is measured and cleared as its cause.
