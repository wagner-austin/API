...
| Very Hard (duel_lake) | `flame-close6` | 35/96 paired fresh seeds (36%) vs `flame-nocover`'s 20/96 on the same seeds | ADOPTED 2026-09-02, the first champion the automated search produced. Laws six and nine both cleared on the win bar: +8 (16-8 of 48, close6vh) then +7 (19-12 of 48, close6rep) against the +4 bar, on disjoint seed sets and independently frozen trees; combined W-boundary flips 29:14, two-sided p = 0.031. One knob from `flame-nocover`: `close 3` -> `close 6`. Prior champion's ten rejected modification arms predate the search vocabulary. |
