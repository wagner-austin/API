...
| Very Hard (duel_lake) | `close0-flame4` | 48/96 paired fresh seeds (50%) vs `flame-close6`'s 29/96 on the same seeds | ADOPTED 2026-09-02, the second search-produced champion in one day. Laws six and nine on the win bar vs the sitting champion flame-close6: **+14** (28-14 of 48, c0f4vh, flips 16:2, p=0.001) then **+5** (20-15 of 48, c0f4rep), disjoint seed sets, independently frozen trees; combined flips 31:12, p=0.005. Two knobs from flame-close6: flame 2->4, close 6->0 (latch deleted). Mechanism open: flame-4 dominance vs flame-close interaction is undistinguished -- close6's own +8/+7 was measured with flame pinned at 2. |
| Impossible (duel_lake) | `flame-nocover` | 0/~120 post-certification, survival floor ~3300; 0/48 vs `flame-close6`'s 0/48 on paired seeds (imp48c6, 2026-09-02) | No adoptable gain: raid 8's +217 REVERSED on a fresh tree (-198, same seeds) and is retracted; kite's +98 is downgraded to unreplicated. The VH champion's `close 6` does NOT transfer: margin delta +0.051 (sd 0.768), zero survivals either arm -- patience is a closing behavior and nothing reaches a closing position here. Champion held by default of evidence. |
