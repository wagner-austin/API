...
| Very Hard (duel_lake) | `flame-nocover` | 21/48 fresh seeds (44%) | Standing, but CHALLENGED: `flame-close6` (the vhsearch2 graduate) cleared law six on 2026-09-02 -- 16/48 won vs control's 8 on fresh seeds, paired win delta +8 against the +4 bar, margin delta +1.084 -- the largest VH win delta since certification. Adoption awaits law nine: the `close6rep` replication on 48 more untouched seeds (15001-19889), in flight. Ten prior modification arms rejected at two scales. |
