...
**Read this first.** 5 topic hubs, 13 content pages. Follow the hub link for your topic; each hub lists its pages with one-line descriptions.
...
[Game Mechanics](hubs/game-mechanics.md) -- the RTS itself: unit stats, economy, build tree, terrain and movement layers, fog (3 pages)
[Bot Architecture](hubs/bot-architecture.md) -- perception, planner, dispatch, coding standards, the contracts that keep the bot honest (9 pages)
