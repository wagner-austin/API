...
**Read this first.** 5 topic hubs, 51 content pages. Follow the hub link for your topic; each hub lists its pages with one-line descriptions.
...
[Bot Architecture](hubs/bot-architecture.md) -- perception, planner, dispatch, coding standards, the contracts that keep the bot honest (36 pages)
