...
**Read this first.** 5 topic hubs, 12 content pages. Follow the hub link for your topic; each hub lists its pages with one-line descriptions.
...
[Engine Internals](hubs/engine-internals.md) -- the obfuscated JVM: class-name mapping, engine objects, the script surface, what survived ProGuard (6 pages)
...
[Bot Architecture](hubs/bot-architecture.md) -- perception, planner, dispatch, coding standards, the contracts that keep the bot honest (8 pages)
