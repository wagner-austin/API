...
Run as ``python -m scripts.margin <batch> [batch...]`` to print each
batch's per-arm mean margin and, where two arms share seeds, the paired
margin delta beside the paired win delta it sharpens.
"""
